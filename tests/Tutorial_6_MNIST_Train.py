...
def parse_args():
    ...
    parser.add_argument('-e','--max_epoch', default="2", help="Training epoch", )
...
if __name__ == "__main__":
    ...
    train_loader, test_loader = load_data(interest_class,datapath,isppd,img_size,batch_size,inference_batch_size,True,num_workers)
